...
classes = ['goods_1','goods_2','goods_3','goods_4','goods_5','goods_6','papper_1','papper_2','papper_3','papper_4','papper_5','papper_6']
...
if __name__ == "__main__":
    postfix = 'jpg'  # 设置图像文件的扩展名
    imgpath = r'dataset\\images\\val'  # 设置图像文件路径
    xmlpath = r'F:\yolov5\dataset\images\val\outputs'  # 设置 XML 标注文件路径
    txtpath = r'dataset\\labels\\val'   # 设置输出的 TXT 文件路径
